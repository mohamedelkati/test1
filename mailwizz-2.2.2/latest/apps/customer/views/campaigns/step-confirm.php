        ...
        <div class="box box-primary borderless">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
			                <?php echo $form->labelEx($campaign, 'send_between_end'); ?>
			                <?php echo $form->dropDownList($campaign, 'send_between_end', CMap::mergeArray(['' => t('app', 'Choose')], $campaign->getSendBetweenHoursList()), $campaign->fieldDecorator->getHtmlOptions('send_between_end', ['class' => 'form-control select2', 'style' => 'width: 100%'])); ?>
			                <?php echo $form->error($campaign, 'send_between_end'); ?>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
					                <?php echo $campaign->t('Optionally, this campaign can send each day between selected hours, using your account timezone.'); ?>
                                    <br /><br />
	                                <?php echo $campaign->t('Please note that using this option will result in much slower delivery as a campaign can span multiple days.'); ?><br />
                                </div>
                            </div>
                        </div>
                    </div>
